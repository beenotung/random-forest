...
export let forestjs = (function () {

    let RandomForest = function (options?) {
    }
    ...
    RandomForest.prototype = {
        ...
        */
        ...
        predict: function (data) {
            ...
            let probabilities = new Array(data.length);
    ...
    let DecisionTree = function (options?) {
    }
    ...
    DecisionTree.prototype = {
        ...
        train: function (data, labels, options) {
            ...
            let trainFun: Function = decision2DStumpTrain;
    ...
    function decisionStumpTrain(data, labels, ix, options?) {
        ...
        for (let i = 0; i < numtries; i++) {
            ...
            let l1 = 1, r1 = 1, lm1 = 1, rm1 = 1; //counts for Left and label 1, right and label 1, left and minus 1, right and minus 1
